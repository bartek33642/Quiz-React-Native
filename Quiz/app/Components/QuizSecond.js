...
import dataFilmQuiz from '../data/QuizGenralTasks'
import {COLORS} from '../styles';

import Icon from 'react-native-vector-icons/MaterialCommunityIcons';

const QuizesPageSecond = () => {
    
    const allQuestions = dataFilmQuiz;
    ...
    //Todo: dokończyć przycisk powrotu do strony głównej
               ...
               >
                ...
                <View style={styles.modalView}>
                    ...
                    <TouchableOpacity onPress={retryQuiz} style={styles.retryButton}>
                        <Text style={{textAlign: 'center'}}>Zagraj raz jeszcze</Text>
                    </TouchableOpacity>
                    
                    
                    {/* Return to home page button */}
                    {/* Todo /*}
                    {/* <TouchableOpacity onPress={backToHomePage} style={styles.backButton}>
                        <Text style={{textAlign: 'center'}}>Wróć do strony głównej</Text>
                    </TouchableOpacity> */}
                    </View>
                </View>
            </Modal>
...
export default QuizesPageSecond;
